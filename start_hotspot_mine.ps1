...
$hotspotpulse = Await ($tetheringManager.StartTetheringAsync()) ([Windows.Networking.NetworkOperators.NetworkOperatorTetheringOperationResult])
write_logFile -log_file "C:\Users\thann\Documents\Angel\output.log" -log_message $hotspotpulse
Get-Content "C:\Users\thann\Documents\Angel\output.log"
Exit